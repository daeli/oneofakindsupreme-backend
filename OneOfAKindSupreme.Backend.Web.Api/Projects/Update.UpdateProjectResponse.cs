...
{
    public class UpdateProjectResponse : IResponse<ProjectRecord>
    {
        private readonly ProjectRecord project;
        private readonly List<string> errors = [];
        private readonly bool succeeded;
        private readonly IList<HypermediaLink>? hypermediaLinks;
        public UpdateProjectResponse(ProjectRecord project, IList<string> errors, bool succeeded, IList<HypermediaLink>? hypermediaLinks) 
        {
